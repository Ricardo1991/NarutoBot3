...
namespace NarutoBot3
{
    public class Bot
    {
        ...
        internal void ReadTrivia() //Reads the Trivia stuff
        {
            tri.Clear();
        ...
        internal void ReadNickGen()//These are for the Nick gen
        {
